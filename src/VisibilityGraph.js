...
export default class VisibilityGraph {
  ...
  async initialize() {
    await createGraphFromGeoJson(this)
  }
  ...
  async addStartAndEndPointsToGraph (origin, destination) {
    ...
    await addSinglePoint(this, this._lastOrigin)
    await addSinglePoint(this, this._lastDestination)
    return {
